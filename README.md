# Polyp_Detection
## 🧠Polyp_Detection Training Guide

This project uses the Polyp_Detection model for training on a custom dataset. Follow these steps to set up and train the model:
...
```bash
python -m venvPolyp_Detection
sourcePolyp_Detection/bin/activate  # On Windows:Polyp_Detection\Scripts\activate
```
